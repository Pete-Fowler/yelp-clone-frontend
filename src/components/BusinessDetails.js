...
function BusinessDetails({
  ...
  const reviewNodes = bizObject.reviews.map((review) => (
    <Review
      review={review}
      key={review.id}
      userId={userId}
  ...
  return (
    <div className="col">
      <div
        id={style.photoHeader}
        style={{
          background: `linear-gradient(to bottom, transparent, rgba(0,0,0,0.75)), url(${bizObject.image_url})`,
          position: "relative",
        }}
      >
        <div
        ...
        >
          ...
          <span className={style.headerSpan}>
            {bizObject.reviews.length !== 0 ? (
              <StarRating reviews={bizObject.reviews} />
            ) : null}
          </span>
          <span className={style.headerSpan}>
            {" "}
            {bizObject.price} • {bizObject.business_type}{" "}
          </span>
        </div>
      </div>
        ...
        <div className="col" id={style.mainContent}>
          <div className="row" id={style.controls}>
            <button
              className="red"
              onClick={() => {
                isLoggedIn ? navigate(`/review/${id}`) : navigate(`/login`);
              }}
            >
              <span role="img">
            ...
            <button>
              <span role="img">
                <svg width="24" height="24" className="icon_svg">
                  <path d="M16 2a1 1 0 01.95.68L17.72 5H20a3 3 0 013 3v11a3 3 0 01-3 3H4a3 3 0 01-3-3V8a3 3 0 013-3h2.28l.77-2.32A1 1 0 018 2h8zm-.72 2H8.72L8 6.32A1 1 0 017 7H4a1 1 0 00-1 1v11a1 1 0 001 1h16a1 1 0 001-1V8a1 1 0 00-1-1h-3a1 1 0 01-.95-.68L15.28 4zM12 7.5a5.5 5.5 0 015.5 5.5 5.51 5.51 0 01-5.5 5.5 5.5 5.5 0 010-11zm0 2a3.5 3.5 0 100 7 3.5 3.5 0 000-7z"></path>
                </svg>
              </span>
              Add photo
            </button>
            <button>
              <span role="img">
                <svg width="24" height="24" className="icon_svg">
                  <path d="M13 5.414V17a1 1 0 01-2 0V5.414L9.707 6.707a1 1 0 01-1.414-1.414l3-3a1 1 0 011.414 0l3 3a1 1 0 11-1.414 1.414L13 5.414zM17 11a1 1 0 010-2h3a2 2 0 012 2v9a2 2 0 01-2 2H4a2 2 0 01-2-2v-9a2 2 0 012-2h3a1 1 0 110 2H4v9h16v-9h-3z"></path>
                </svg>
              </span>
              Share
            </button>
          ...
          <div className={`col outlineBox`}>
            ...
            <div className="row">
              <div className="col">
                ...
                <span
                  style={{ color: "rgba(110,112,114,1)", fontSize: "16px" }}
                >
                  {bizObject.address}
                </span>
              </div>
