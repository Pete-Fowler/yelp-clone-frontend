      ...
      <div className="col">
        <div className="row centered">
          <button className={style.category} onClick={() => categorySearch('restaurants')}>
            <img src="https://s3-media0.fl.yelpcdn.com/assets/srv0/yelp_design_cdn/8bc05b287157/assets/img/svg_illustrations/40x40_food_v2.svg" alt="restaurants"/>
            Restaurants
          </button>
        ...
        <div className="row centered">
          ...
          <button className={style.category} onClick={() => categorySearch('auto')}>
            <img src="https://s3-media0.fl.yelpcdn.com/assets/srv0/yelp_design_cdn/5967f38fe621/assets/img/svg_illustrations/40x40_auto_v2.svg" alt="auto"/>
            Automotive
          </button>
